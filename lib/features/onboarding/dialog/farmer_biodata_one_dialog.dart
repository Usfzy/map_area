...
Future<void> showFarmerBiodataOneDialog(BuildContext context) {
 return showDialog(
      context: context,
      builder: (_) => AlertDialog(
        content: FarmerBiodataOneDialog(),
...
class FarmerBiodataOneDialog extends StatelessWidget {
  @override
            ...
            child: Column(
                ...
                children: [
                  Padding(
                      ...
                      child: Text("Ahmed Kunle Obiora Has been Onboarded. ",
  ...
  onTapVewprofile(BuildContext context) {
    context.pushReplacementNamed(AppRoutes.farmerProfileScreen);
  }
}
