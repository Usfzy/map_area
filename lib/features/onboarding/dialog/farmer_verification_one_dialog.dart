...
Future<void> showFarmerVerificationOneDialog(BuildContext context) {
  return showDialog(
      context: context,
      builder: (_) => AlertDialog(
            content: FarmerVerificationOneDialog(),
...
class FarmerVerificationOneDialog extends StatelessWidget {
  ...
  onTapProceed(BuildContext context) {
    context.pushReplacementNamed(AppRoutes.farmerBiodataScreen);
  }
}
